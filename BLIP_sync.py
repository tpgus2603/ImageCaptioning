...
def main(local_rank):
    ...
    # Training function with epoch timing and gradient accumulation
    def train_model(model, train_loader, val_loader, optimizer, scheduler, num_epochs=5, patience=2, accumulation_steps=2):
        ...
        for epoch in range(num_epochs):
            ...
            for i, batch in enumerate(train_loader):
                ...
                # Apply no_sync if not synchronizing at this step
                ...
                # Accumulate gradients over several steps before updating
            ...
            # Sync before validation to ensure all GPUs are at the same state
            dist.barrier()
